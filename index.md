...
- **snížení požadavků** na zdroje
  ...
  - **deadline** - první se zpracuje požadavek, kterému nejdříve skončí deadline
...
- snažíme se **minimalizovat coupling (provázanost)** a **maximalizovat cohesion (soudržnost)** $\Rightarrow$ tím se zvyšuje modularita
